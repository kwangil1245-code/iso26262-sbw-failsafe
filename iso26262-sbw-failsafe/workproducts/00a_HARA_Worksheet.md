...
| :---: | --- | --- | :---: | :---: | :---: | :---: | --- |
| HC-01 | 조향 정보 전달 과정의 통신 이상으로 운전자 의도와 다른 조향 출력이 발생함 | 차량 주행 중 입력 ECU 또는 차량 네트워크의 이상으로 조향 정보가 정상적으로 수신되지 않는 상황 | S3 | E4 | C3 | D | **SG-01:** 조향 정보가 정상적으로 수신되지 않는 상태를 감지하고 운전자 의도와 다른 위험한 조향 출력이 발생하지 않도록 해야 한다. |
